...
export const CompanyKPI: React.FC<CompanyKPIProps> = ({ currentAmount }) => {
  ...
  const currentTarget = settings.kpiTargets.find(t => t.type === 'company');

  // Initialize targets when editing starts
  useEffect(() => {
        ...
        <div className="space-y-6">
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              ...
              <h4 className="font-medium text-gray-900">Collection Targets</h4>
            </div>
            <div>
        ...
        {currentTarget ? (
          <>
            ...
            <div className="space-y-4">
              ...
              {renderProgressBar('Daily Box Target', currentAmount, currentTarget.boxDailyTarget || 0, 'boxes')}
              {renderProgressBar('Weekly Box Target', currentAmount, currentTarget.boxWeeklyTarget || 0, 'boxes')}
              {renderProgressBar('Monthly Box Target', currentAmount, currentTarget.boxMonthlyTarget || 0, 'boxes')}
            </div>
          </>
        ) : (
